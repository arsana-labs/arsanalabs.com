    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center h-screen w-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <Image
          ...
          src="https://arsana-labs.github.io/arsanalabs/logo-h-trans-croped.png"
          alt="arsanalabs logo"
          width={180}
          height={38}
          priority
        ...
        <ol className="list-inside text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)]">
          <li className="mb-2">We build open-source products.</li>
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            ...
            href="https://github.com/arsana-labs"
            target="_blank"
          ...
          <a
            ...
            href="https://github.com/orgs/arsana-labs/people"
            target="_blank"
            rel="noopener noreferrer"
          >
            Visit our team
